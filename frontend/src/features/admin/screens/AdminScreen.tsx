...
const styles = StyleSheet.create({
  ...
  deniedIcon: { width: 80, height: 80, borderRadius: 40, backgroundColor: THEME.dangerDim, justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
  deniedTitle: { fontSize: 24, fontWeight: '700', color: THEME.danger, letterSpacing: 3 },
  deniedSubtitle: { fontSize: 12, color: THEME.textSecondary, marginTop: 8, letterSpacing: 1 },

  header: { paddingTop: 50, paddingHorizontal: 16, paddingBottom: 16 },
  headerTop: { marginBottom: 16 },
  titleBlock: {},
  titleRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 4 },
  iconBox: { width: 36, height: 36, borderRadius: 8, backgroundColor: THEME.accentGlow, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: THEME.accentDim },
  title: { fontSize: 20, fontWeight: '700', color: THEME.textPrimary, letterSpacing: 2 },
  subtitle: { fontSize: 10, color: THEME.textSecondary, letterSpacing: 1 },

  statsGrid: { flexDirection: 'row', gap: 8, marginBottom: 16 },
  statBox: { flex: 1, padding: 12, borderRadius: 8, backgroundColor: THEME.surface, borderWidth: 1, alignItems: 'center' },
  statValue: { fontSize: 22, fontWeight: '700', color: THEME.textPrimary },
  statLabel: { fontSize: 9, color: THEME.textMuted, marginTop: 4, letterSpacing: 1 },

  tabScroll: { marginHorizontal: -16 },
  tabScrollContent: { paddingHorizontal: 16, paddingRight: 26 },
  tabBar: { flexDirection: 'row', gap: 8 },
  tabButton: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 6, backgroundColor: THEME.surface, borderWidth: 1, borderColor: THEME.border, gap: 8 },
  tabLabel: { fontSize: 11, fontWeight: '600', color: THEME.textSecondary, letterSpacing: 1 },
  tabBadge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  tabBadgeText: { fontSize: 9, fontWeight: '700', color: THEME.background },

  loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  loaderBox: { alignItems: 'center' },
  loadingText: { fontSize: 12, color: THEME.accent, marginTop: 16, letterSpacing: 2 },

  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  emptyText: { fontSize: 16, color: THEME.textSecondary, marginTop: 16, letterSpacing: 1 },
  emptySubtext: { fontSize: 10, color: THEME.textMuted, marginTop: 4 },

  listContent: { padding: 16, paddingBottom: 100 },

  eventCard: { marginBottom: 12, borderRadius: 10, borderWidth: 1, overflow: 'hidden', backgroundColor: THEME.surface, borderColor: THEME.border },
  ...
  moreButton: { marginLeft: 6, width: 24, height: 24, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: THEME.background },
  newOrgBadge: { backgroundColor: THEME.warningDim, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 3 },
  newOrgText: { fontSize: 7, fontWeight: '700', color: THEME.warning, letterSpacing: 0.5 },
  ...
  eventTitle: { fontSize: 14, fontWeight: '600', color: THEME.textPrimary, paddingHorizontal: 10, marginBottom: 8 },
  organizerInfo: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, gap: 8, marginBottom: 10 },
  avatar: { width: 24, height: 24, borderRadius: 12 },
  organizerDetails: {},
  organizerName: { fontSize: 12, fontWeight: '600', color: THEME.textPrimary },
  submitTime: { fontSize: 9, color: THEME.textSecondary },
  ...
  rejectionText: { fontSize: 11, color: THEME.danger, flex: 1 },

  cardActions: { flexDirection: 'row', padding: 10, gap: 8, borderTopWidth: 1, borderTopColor: THEME.border },
  ...
  modalContent: { backgroundColor: THEME.surface, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, paddingBottom: 40 },
  successModalCard: { backgroundColor: THEME.surface, borderRadius: 14, borderWidth: 1, borderColor: THEME.accentDim, padding: 18 },
  successIconWrap: { width: 42, height: 42, borderRadius: 21, backgroundColor: THEME.accentGlow, borderWidth: 1, borderColor: THEME.accentDim, alignItems: 'center', justifyContent: 'center', marginBottom: 14 },
  successTitle: { fontSize: 16, fontWeight: '700', color: THEME.accent, letterSpacing: 1, marginBottom: 8 },
  successMessage: { fontSize: 13, color: THEME.textPrimary, lineHeight: 19, marginBottom: 16 },
  successButton: { alignSelf: 'flex-end', backgroundColor: THEME.accentGlow, borderWidth: 1, borderColor: THEME.accentDim, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  successButtonText: { color: THEME.accent, fontWeight: '700', letterSpacing: 0.8 },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  modalTitle: { fontSize: 18, fontWeight: '700', color: THEME.danger, letterSpacing: 1 },
  modalSubtitle: { fontSize: 11, color: THEME.textSecondary, marginBottom: 16, letterSpacing: 1 },
  actionsModalContent: { backgroundColor: THEME.surface, borderRadius: 12, marginHorizontal: 20, marginBottom: 120, borderWidth: 1, borderColor: THEME.border },
  ...
  reasonRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: THEME.border },
  radioDot: { width: 16, height: 16, borderRadius: 8, borderWidth: 2, borderColor: THEME.textSecondary, marginRight: 12 },
  reasonText: { fontSize: 14, color: THEME.textPrimary, flex: 1 },
  noteInput: { backgroundColor: THEME.background, borderRadius: 8, padding: 14, color: THEME.textPrimary, marginTop: 16, minHeight: 60, fontSize: 14 },
  rejectButton: { backgroundColor: THEME.danger, paddingVertical: 14, borderRadius: 8, marginTop: 16, alignItems: 'center' },
  rejectButtonDisabled: { backgroundColor: THEME.textSecondary },
